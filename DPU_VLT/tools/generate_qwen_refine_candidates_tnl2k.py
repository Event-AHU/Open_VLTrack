...
def parse_args():
    parser = argparse.ArgumentParser(description="Generate multi-candidate Qwen refine outputs for TNL2K train anchors.")
    ...
    parser.add_argument("--parsed-text-path", required=True, help="Path to parsed TNL2K text json.")
...
def main():
    ...
    for seq_id in seq_ids:
        ...
        for frame_id in anchor_ids:
            parsed = dataset.get_language_description(seq_id, int(frame_id))
